...
#include <gba_video.h>
#include <gba_input.h>
#include "video.h"      // Donde están vline, fill_rect, etc.
#include "font.h"
#include "save.h"
#include "sacos.h"      // Aquí está definida la estructura Saco
#include "util.h"       // Aquí están los prototipos de vline, fill_rect y taller_recargar
