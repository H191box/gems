// 2.0 - Con soporte de guardado persistente
#include <stdint.h>
#include <gba_video.h>
#include <gba_input.h> // Necesario para detectar teclas
#include "video.h"
#include "font.h"
#include "save.h"      // Importante para persistencia
...
void dibujar_menu(int opcion) {
    ...
    draw_text(vram, 16, 54, "B:GUARDAR  A:IR", 255);
...
// Lógica de control sugerida para poner en tu bucle principal:
/*
void manejar_menu_input(uint16_t keys) {
    if (keys & KEY_B && opcion == 0) {
        guardar_partida(); // Guarda en SRAM física al pulsar B en Farmear
    }
}
*/
